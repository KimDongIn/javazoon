...
?>
	...
	<link type="text/css" rel="stylesheet" href="/css/coffeinfo.css">
...
<!--===================================-->
	<link rel="stylesheet" href="/young/theme/basic/css/default_shop.css?ver=191202">
	<link rel="stylesheet" href="/young/js/font-awesome/css/font-awesome.min.css?ver=191202">
	<link rel="stylesheet" href="/young/js/owlcarousel/owl.carousel.css?ver=191202">
	<link rel="stylesheet" href="/young/skin/shop/basic/style.css?ver=191202">
...
<body style="background: #ffffff;">	
	...
	<header id="header">
<?
	include_once($_SERVER["DOCUMENT_ROOT"].'/pieceHead.php');
?>
	</header>
<nav id="nav" class="origins">
<?
	include_once($_SERVER["DOCUMENT_ROOT"].'/pieceNav.php');
?>
</nav>
<article id="sideBar" class="sideAnimateOut">
<?
	include_once($_SERVER["DOCUMENT_ROOT"].'/pieceSidebar.php');
?>
</article>
<!-- side butten -->
	...
	<main>
		...
		<!--section class="sec01">
				<div class="bgImg">
					<img id="OriginsBg" src="">
				</div>
			<div class="sectionSell01">


				<div class="topName">
					<h1 id="originsTitel01"></h1>
				</div>
