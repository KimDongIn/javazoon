...
<main>
    ...
    ?>
					...
					<div id="sod_bsk_act">
						<?php if ($i == 0) { ?>
						<a href="/mainPage.php<?php// echo G5_SHOP_URL; ?>/" class="btn01">쇼핑 계속하기</a>
						<?php } else { ?>
						<input type="hidden" name="url" value="./orderform.php">
						<input type="hidden" name="records" value="<?php echo $i; ?>">
						<input type="hidden" name="act" value="">
						<a href="/mainPage.php<?php// echo shop_category_url($continue_ca_id); ?>" class="btn01">쇼핑 계속하기</a>
