		...
		<div class="sectionSell03">
			...
			<div class="moreinfo">
				<div class="row">
					<div class="cofeHis">
						<span>ORIGIN</span>
						<h1 id="hiscont01"><span class="oriDec"></span></h1>
					</div>
				</div>
				<div class="row">
					<div class="cofeHis">
				...
				<div class="row">
					...
					<div class="col">
						<div class="cofeHis">
							<span>NUMBER OF COFFEE FARMS / FARMERS</span>
							<span class="arrow01"></span>
							<h3>
								<span class="oriDec"></span>
							</h3>
				...
				<div class="row">
					<div class="col">
						<div class="cofeHis">
							<span>YEARLY PRODUCTION TOTAL (IN 60KG BAGS)</span>
							<span class="arrow01"></span>
							<h3><span class="oriDec"></span></h3>
						</div>
					</div>
			...
			<?
					$que1 = " select * 
								from coffeImg 
								where Country='{$it['it_name']}';
							";
							$item1 = sql_query($que1);
			?>
				
				<ul class="product_list">
					<?while($it_img=sql_fetch_array($item1)){?>
						<li><img src="/img/coffeImg/<?echo $it_img['img'];?>" alt=""></li>
					<?}?>
				</ul>
			</div>
			<div class="potoListMenu">
				<div class="potoCount">
					<h1><span id="potoNum"></span></h1>
				</div>
				<a id="prevBtn">
