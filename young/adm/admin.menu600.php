<?php
$menu["menu600"] = array (
    array('600000', '달력 이벤트', ''.G5_ADMIN_URL.'/shop_admin/coffelist.php', 'sms5'),
	//<a href="./coffelist.php" onclick="return excelform(this.href);" target="_blank" class="btn btn_02">상품리스트</a>
    //array('600100', '상품 리스트 업로드', ''.G5_ADMIN_URL.'/shop_admin/coffelist.php', 'sms5_config' ),
