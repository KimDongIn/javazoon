			...
			<section class="sec01">
				<div class="sectionSell01">
					...
					<div class="tabmenuSell">
						...
						<label for="tab01" class="bgColor02">
							<span>개인회원</span>
						</label>

						<input type="radio" name="tabmenu" id="tab02">
						<label for="tab02" class="bgColor01">
							<span>기업회원</span>
						</label>
					</div>
					...
					<div class="boardWrite box1">
						<!--개인회원가입=================================================-->
						<form id="fregisterform" name="fregisterform" action="./young/bbs/register_form_update1.php" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
							...
							<div class="boardForm">
								...
								<!--div class="col-all-6">
									<input type="text" name="place3" id="place3" placeholder="주소1">
								</div>
								<div class="col-all-6">
									<input type="text" name="place3" id="place3" placeholder="주소2">
								</div-->
...
-->
								...
								<div class="col-all-12">
									<input type="text" name="mb_company_number" value="" id="reg_mb_hp" placeholder="사업자 등록번호">
								</div>
