		...
		<div class="mainSell">
			...
			<section class="sec02">
				<div class="sectionSell02">
						...
						<div class="midText">
							...
							<div class="row">
								...
								<div class="col contact02">
									...
									<h2><span>Tel :</span>010-000-0000</h2>
									<h2><span>email :</span>010-000-0000</h2>
								</div>
							</div>
					...
					?>
							<li onclick="javascript:pageWp(<?=$i?>)">
								<input type="hidden" name="it_id" value="<?=$row['it_id']?>">
								
								<!--comfirm 로스팅으로 링크 변경해야함-->
